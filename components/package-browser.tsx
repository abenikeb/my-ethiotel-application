...
const PACKAGES: Package[] = [
  ...
  // Data Packages
  { id: "7", name: "Internet Night for 210 MB", category: "data", data: 210, price: 3, frequency: "daily" },
  {
    id: "8",
  ...
  { id: "9", name: "Internet Night for 512 MB", category: "data", data: 512, price: 5, frequency: "daily" },
  {
    id: "10",
  ...
  { id: "11", name: "Internet Night for 1 GB", category: "data", data: 1024, price: 7, frequency: "daily" },
  {
    id: "12",
  ...
  // 5G Packages
  { id: "13", name: "Monthly 5G Package for 150GB", category: "5g", data: 150000, price: 1500, frequency: "monthly" },
  { id: "14", name: "Monthly 5G Package for 250GB", category: "5g", data: 250000, price: 1800, frequency: "monthly" },
  {
    id: "15",
  ...
  { id: "16", name: "Monthly 5G Unlimited Premium", category: "5g", data: 999999, price: 2450, frequency: "monthly" },

  // SMS Packages
  { id: "17", name: "SMS Bundle 50", category: "sms", sms: 50, price: 3, frequency: "daily" },
  { id: "18", name: "SMS Bundle 100", category: "sms", sms: 100, price: 5, frequency: "daily" },

  // CRBT
  { id: "19", name: "Normal CRBT Service", category: "crbt", price: 7, frequency: "monthly" },
  { id: "20", name: "Calling CRBT Service", category: "crbt", price: 7, frequency: "monthly" },

  // Roaming
  { id: "21", name: "Umrah Roaming Package", category: "roaming", price: 100, frequency: "weekly" },
]
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-card border-b border-border sticky top-0 z-40 px-4 py-4 flex items-center gap-3">
        ...
        <h1 className="text-xl font-semibold text-foreground flex-1">Packages</h1>
        <button onClick={() => setShowFilters(!showFilters)} className="p-2 hover:bg-muted rounded-lg transition">
