...
export function PackageBrowser() {
	...
	return (
		<div className="min-h-screen bg-background">
			...
			<div className="fixed bottom-12 right-0 p-4 z-30">
				<Link href="/packages/create">
					<button className="w-full py-3 px-5 text-2xl rounded-full bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-all">
