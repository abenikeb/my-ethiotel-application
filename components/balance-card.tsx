...
export function BalanceCard({ onSeeMoreClick }: BalanceCardProps) {
	...
	return (
		<div className="relative pt-2 pb-8 pl-8 pr-8 text-white space-y-6 gradient-pattern rounded-3xl overflow-hidden">
			{/* Header with greeting */}
			<header className=" text-white flex items-center justify-between sticky top-0 z-50 border-0 relative mb-5">
				<div className="flex items-center gap-3 relative z-10">
					<div className="relative w-10 h-10 flex-shrink-0 p-1.5 rounded-xl border border-white/40 shadow-lg">
						<Image
